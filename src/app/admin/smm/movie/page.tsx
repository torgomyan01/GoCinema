...
import AdminSmmMovieClient from '@/components/admin/admin-smm-movie-client';
...
export const metadata: Metadata = {
  title: 'Ֆիլմի հայտարարություն · SMM - Ադմինիստրատոր - GoCinema',
};

export default async function AdminSmmMoviePage() {
  unstable_noStore();
