...
import AdminSmmTodayClient from '@/components/admin/admin-smm-today-client';
...
export const metadata: Metadata = {
  title: 'Այսօր կինոյում · SMM - Ադմինիստրատոր - GoCinema',
};

export default async function AdminSmmTodayPage() {
  unstable_noStore();
