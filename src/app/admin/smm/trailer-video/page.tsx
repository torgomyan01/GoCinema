...
import AdminSmmTrailerVideoClient from '@/components/admin/admin-smm-trailer-video-client';
...
export const metadata: Metadata = {
  title: 'Թրեյլերի վիդեո · SMM - Ադմինիստրատոր - GoCinema',
};

export default async function AdminSmmTrailerVideoPage() {
  unstable_noStore();
