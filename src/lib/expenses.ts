...
export const EXPENSE_CATEGORY_META: Record<ExpenseCategory, ExpenseCategoryMeta> =
  {
    ...
    marketing: {
      ...
      hint: 'Facebook, Instagram, Google և այլ գովազդ։ Իրացման ծախս է — շրջհարկը նվազեցնում է, եթե կա հաշիվ/վճարման փաստաթուղթ։ Սա ներկայացուցչական ծախս չէ։',
      group: 'operations',
      reducesTurnoverTax: true,
    },
    communication: {
...
export function expenseCategoryLabel(category: string): string {
  ...
  return EXPENSE_CATEGORY_LABELS[str] || str || EXPENSE_CATEGORY_META.other.label;
}
